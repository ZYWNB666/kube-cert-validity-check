...
## Deploy
将 https://github.com/ZYWNB666/kube-cert-validity-check/blob/main/deploy/kube-cert-validity-check.yaml 文件放到 /etc/kubernetes/manifests/ 目录下即可，kubelet会自动检测，然后启动这个pod
